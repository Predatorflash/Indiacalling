...
<center><h1 style=color:black>Delete Plan</h1></center>
<center>
<br>
<table bgcolor='#fff3e6' align='center' border='2' cellpadding='4'>
<tr>
<th align='center'>
PLANID
</th>
...
VALIDITY
       ...
       <c:forEach var="user" items="${results}">
  		...
  		<tr><td align="left"><c:out value="${user.planId}"/></td>
            ...
            <td><a href="UpdatePlanServlet?param=${user.planId}">Update</a></td>
            <td><a href="DeletePlanServlet?id=${user.planId}">Delete</a></td>
              </tr>
</c:forEach> </table>
<br>
</center>
