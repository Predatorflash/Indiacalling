...
<center><h1 style=color:black>Add New Location</h1></center><br> 
<center>
<br><br> 
...
CONTACTNO
 ...
 <form method="get" action="AddNewLocation.jsp">
<br>
<center><input type="submit" name="addloc" id="addloc" class="button" value="Add Location"></center>
</form><br>
