...
<br><br>  
<center>
<% out.print("<table bgcolor='white' align='center' border='2' cellpadding='4' >");
out.print("<tr>");
...
out.print("</tr>");%>
       ...
       <c:forEach var="user" items="${postpaid}">
  		...
  		<td align="left"><c:out value="${user.type}"/></td>
            ...
            <td><a href="PlanDetailServlet?p=${user.amount}&param=bill">Pay Bill</a></td>
              </tr>
</c:forEach> <% out.print("</table>");%>
